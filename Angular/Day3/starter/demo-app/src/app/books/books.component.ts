...
export class BooksComponent implements OnInit{
  ...
  ngOnInit(): void {
    this.dataSource = [{"title":"Scala","isbn":"123456","author":"Martin Odersky","description":"Come and have fun with Scala","pub_Date":new Date("2018-01-01"),"cat":{"id":5,"name":"Non Fiction"},"publisher":"OReilly","availability":"yes"},
